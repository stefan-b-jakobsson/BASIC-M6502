...
LINWID:	.res 1
NCMWID:	.res 1 				;POSITION BEYOND WHICH THERE ARE
					;NO MORE FIELDS.
	.zeropage
LINNUM:	.res 1				;LOCATION TO STORE LINE NUMBER BEFORE BUF
					;SO THAT "BLTUC" CAN STORE IT ALL AWAY AT ONCE.

	.res 1				;A COMMA (PRELOAD OR FROM ROM)
...
FAC:	
FACEXP:	.res 1
FACHO:	.res 1				;MOST SIGNIFICANT BYTE OF MANTISSA.
FACMOH:	.res 1				;ONE MORE.
FACMO:	.res 1				;MIDDLE ORDER OF MANTISSA.
FACLO:	.res 1				;LEAST SIG BYTE OF MANTISSA.
FACSGN:	.res 1				;SIGN OF FAC (0 OR -1) WHEN UNPACKED.
SGNFLG:	.res 1				;SIGN OF FAC IS PRESERVED BERE BY "FIN".
...
BITS:	.res 1				;SOMETHING FOR "SHIFTR" TO USE.
...
ARISGN:	.res 1				;A SIGN REFLECTING THE RESULT.
FACOV:	.res 1				;OVERFLOW BYTE OF THE FAC.
...
RNDX:	.res 1 ;128			;LOADED OR FROM ROM.
	.res 1 ;79			;THE INITIAL RANDOM NUMBER.
	.res 1 ;199
	.res 1 ;82
	.res 1 ;89			;ONE MORE BYTE.
...
ERRTAB:	.byt "NEXT WITHOUT FO", 'R'+128
	ERRNF = 0
	.byt "SYNTA", 'X'+128
	ERRSN = 16
	.byt "RETURN WITHOUT GOSU", 'B'+128
	ERRRG = 22
	.byt "OUT OF DAT", 'A'+128
	ERROD = 42
	.byt "ILLEGAL QUANTIT", 'Y'+128
	ERRFC = 53
	.byt "OVERFLO", 'W'+128
	ERROV = 69
	.byt "OUT OF MEMOR", 'Y'+128
	ERROM = 77
	.byt "UNDEF'D STATEMEN", 'T'+128
	ERRUS = 90
	.byt "BAD SUBSCRIP", 'T'+128
	ERRBS = 107
	.byt "REDIM'D ARRA", 'Y'+128
	ERRDD = 120
	.byt "DIVISION BY ZER", 'O'+128
	ERRDV0 = 133
	.byt "ILLEGAL DIREC", 'T'+128
	ERRID = 149
	.byt "TYPE MISMATC", 'H'+128
	ERRTM = 163
	.byt "STRING TOO LON", 'G'+128
	ERRLS = 176
	.byt "FILE DAT", 'A'+128
	ERRBD = 191
	.byt "FORMULA TOO COMPLE", 'X'+128
	ERRST = 200
	.byt "CAN'T CONTINU", 'E'+128
	ERRCN = 219
	.byt "UNDEF'D FUNCTIO", 'N'+128
	ERRUF = 233
...
INCHR:	JSR CQINCH  			;FOR COMMODORE.
...
QPLOP:	BPL PLOOP 			;IS IT A TOKEN? NO, HEAD FOR PRINTER.
	CMP #PI
	BEQ PLOOP
...
NOTFNS:	PLA 				;CHECK WHO'S CALLING.
	PHA 				;RESTORE IT.
	CMP #>(ISVRET-1)		; Original code: CMP #ISVRET - 1 - (ISVRET - 1 ) / 256 * 256 ;IS EVAL CALLING?
...
NONONO:	BEQ QINTGO 			;NO, FAC IS TOO BIG.
	JMP FCERR
...
PEEK:	PSHWD POKER
	...
	BCC GETCON
	CMP #<LASTWR			; Original code: CMP #LASTWR / 256
...
FNWAIT:	JSR GETNUM
	...
	LDX #0
	JSR CHRGOT
	BEQ ZSTORD			; Original code: BEQ ZSTORDO, might be part of the
					; Gate's "Easter Egg"
...
WORDS:	.byt " BYTES FREE"
	...
	.byt 0
FREMES:	
	.byt "**** OPEN X16 BASIC ****", 13
	.byt "COPYRIGHT 1978 MICROSOFT", 13
	.byt 13
	.byt 13
	.byt 0
...
LASTWR:	
	; Original code: BLOCK 100 ;SPACE FOR TEMP STACK.
	; This is ROM, and it makes no sense to allocate
	; space with BLOCK, equivalent to .res in ca65 format.
	; The LASTWR label is, however, used in the code, probably
	; to reference end of the BASIC
